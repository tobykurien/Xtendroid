...
// myButton getMyButton() lazy-getter generated by @AndroidActivity
myButton.onClickListener = [View v|    // lambda params (optional)
   toast("Hello, world!")
]
```
...
the ```build/generated``` folder, which gets compiled normally. Full bilateral 
